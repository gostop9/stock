...
class StockPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        print(str(len(item['收盘价前复权']))+' 收盘价前复权\n')
        ...
        text = '\ncode '+'name '+'a股流通市值 '+'dde大单净量 '+'换手率 '+'涨跌幅前复权 '+'量比 '+'现价 '+'主动买卖比差 '+'振幅 '+'机构动向 '+'股性评分 '+'dde大单净额 '+'主力资金流向 '+'中单净额 '+'小单净额 '+'净利润同比增长率 '+'净利润\n'
